// TODO: Use the simpler name `TextureFormat` for a public-facing interface for texture internal formats. Rename this to something else. Merge the internal formats into one enumeration.
