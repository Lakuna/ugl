/**
 * Formats for the color components in a texture. In the WebGL API, these are typically passed to functions with the parameter name `format` (not `internalFormat`).
 * @internal
 */
const enum TextureDataFormat {
...
export default TextureDataFormat;
