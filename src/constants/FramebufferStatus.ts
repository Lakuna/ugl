...
enum FramebufferStatus {
	...
	/**
	 * The values of the samples are different among attached renderbuffers, or
	 * are non-zero if the attached images are a mix of renderbuffers and
	 * textures.
	 */
	FRAMEBUFFER_INCOMPLETE_MULTISAMPLE = 0x8d56,

	/**
	 * If the base view index is not the same for all framebuffer attachment
	 * points where the object type is set, the framebuffer is considered
	 * incomplete.
	 */
