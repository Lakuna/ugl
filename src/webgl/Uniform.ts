...
export class Uniform extends Variable {
   ...
   */
  constructor(program: Program, index: number, textureUnit: number) {
    super(program);
    ...
    switch (this.activeInfo.type as UniformType) {
      case UniformType.FLOAT:
        ...
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform1fv(location, value);
        break;
      case UniformType.FLOAT_VEC2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform2fv(location, value);
        break;
      case UniformType.FLOAT_VEC3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform3fv(location, value);
        break;
      case UniformType.FLOAT_VEC4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform4fv(location, value);
        break;
      case UniformType.SAMPLER_2D:
			case UniformType.SAMPLER_3D:
			case UniformType.SAMPLER_CUBE:
        ...
        this.arraySetter = (value: Texture[]): void => {
      ...
      case UniformType.INT:
        ...
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform1iv(location, value);
        break;
      case UniformType.BOOL_VEC2:
      case UniformType.INT_VEC2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform2iv(location, value);
        break;
      case UniformType.BOOL_VEC3:
      case UniformType.INT_VEC3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform3iv(location, value);
        break;
      case UniformType.BOOL_VEC4:
      case UniformType.INT_VEC4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform4iv(location, value);
        break;
      case UniformType.UNSIGNED_INT:
        this.setter = (value: number): void => this.gl.uniform1ui(location, value);
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform1uiv(location, value);
        break;
      case UniformType.UNSIGNED_INT_VEC2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform2uiv(location, value);
        break;
      case UniformType.UNSIGNED_INT_VEC3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform3uiv(location, value);
        break;
      case UniformType.UNSIGNED_INT_VEC4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniform4uiv(location, value);
        break;
      case UniformType.FLOAT_MAT2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix2fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix3fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix4fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT2x3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix2x3fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT2x4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix2x4fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT3x2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix3x2fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT3x4:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix3x4fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT4x2:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix4x2fv(location, false, value);
        break;
      case UniformType.FLOAT_MAT4x3:
        this.arraySetter = (value: Iterable<number>): void => this.gl.uniformMatrix4x3fv(location, false, value);
        break;
      default:
  ...
  protected readonly arraySetter: ((value: Iterable<number>) => void) | ((value: Texture[]) => void);

  /** The value of this uniform. */
  #value: number | Iterable<number> | Texture | Texture[];

  /** The value of this uniform. */
  get value(): number | Iterable<number> | Texture | Texture[] {
    return this.#value ?? 0;
  }
  set value(value: number | Iterable<number> | Texture | Texture[]) {
    if (Array.isArray(value)) {
      (this.arraySetter as (value: Iterable<number>) => void)(value as Iterable<number>);
    } else {
