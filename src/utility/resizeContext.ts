 ...
 */
function resizeCanvasBuffer(canvas: HTMLCanvasElement): boolean {
	// Physical size.
...
export default resizeCanvasBuffer;

/**
 * Resizes the viewport to match the current drawing buffer.
...
/**
 * Resizes the viewport to match the given size.
...
/**
 * Resizes the scissor box to match the given size and enables the scissor test.
 * @param gl The rendering context to resize.
