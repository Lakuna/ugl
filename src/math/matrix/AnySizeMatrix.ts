...
export class AnySizeMatrix extends Array<number> implements Matrix {
   ...
   */
  public clone(): AnySizeMatrix {
    return new AnySizeMatrix(...this);
  }
  ...
  public invert(): this {
    ...
    const identity: AnySizeMatrix = this.clone().identity();
    const copy: AnySizeMatrix = this.clone();
